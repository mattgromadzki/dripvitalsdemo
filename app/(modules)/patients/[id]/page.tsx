...
import { MessagesTab }    from "@/components/modules/chart/MessagesTab";
    ...
    <div className="px-7 py-6 text-[14px] leading-relaxed">
      ...
      <div className="grid grid-cols-[300px_1fr] gap-4 items-start max-[1000px]:grid-cols-1">
        ...
        <div className="min-w-0">
          ...
          {tab === "orders_current" && <><PatientPharmacyTracking patientId={patient.id} /><OrdersRxTab   patient={patient} extra={extra} /></>}

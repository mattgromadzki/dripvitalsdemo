...
export interface SendEmailInput { to: string; toName?: string; subject: string; html: string; templateId?: string; from?: string; headers?: Record<string, string>; disableProviderTracking?: boolean }

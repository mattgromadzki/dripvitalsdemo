...
export const EMAIL_TEMPLATES: EmailTemplate[] = [
  ...
  { id: "appointment", name: "Visit reminder", category: "Scheduling",
    subject: "Upcoming visit reminder",
    html: "<p>Hi {{firstName}},</p><p>This is a reminder about your upcoming check-in with your {{clinic}} provider. Please have your recent weight and any questions ready.</p><p>— {{clinic}}</p>" },

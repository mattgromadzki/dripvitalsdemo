...
export const PERMISSION_GROUPS: { group: string; perms: Perm[] }[] = [
  ...
  { group: "Outreach", perms: [{ key: "farming.manage", label: "Manage cold outreach / farming" }] },
...
export const DEFAULT_ROLE_PERMS: Record<string, string[]> = {
  ...
  support: ["patients.view", "patients.edit", "email.send", "sms.send", "campaigns.send", "farming.manage"],

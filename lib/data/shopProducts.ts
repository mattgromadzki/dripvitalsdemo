...
/* Seed catalog for the patient-portal Shop. Mirrors the live storefront 1:1.
   ...
   Each `url` deep-links to the matching intake form. */
export const SHOP_PRODUCTS: ShopProduct[] = [
  ...
  {
    id: "SHOP-009", name: "Lipotropic Injections", cat: "weight", tag: "WEIGHT LOSS · RX",
    desc: "Weekly MIC + B12 injection to support fat metabolism & energy.",
    longDesc: "A weekly lipotropic injection combining methionine, inositol, choline, and B12 to support fat metabolism, energy, and your weight-loss routine.",
    price: 129, firstMonth: 99, img: "💉", cls: "green", url: "/intake-form/lipotropic-injection", published: true, sort: 9, clicks: 22,
    benefits: ["Supports fat metabolism & energy", "Added B12 for an energy boost", "Quick weekly injection", "Pairs well with a weight-loss plan"],
    safety: "Not recommended during pregnancy or breastfeeding. Tell your provider about kidney or liver disease or any allergy to B vitamins or injection components.",
  },
  {
    id: "SHOP-010", name: "NAD+ Nasal Spray", cat: "anti-aging", tag: "ANTI AGING · RX",
    ...
    price: 199, firstMonth: 99, img: "💨", cls: "purple", url: "/intake-form/nad-topical-nasal", published: true, sort: 10, clicks: 41,
  ...
  {
    id: "SHOP-011", name: "NAD+ Injections", cat: "anti-aging", tag: "ANTI AGING · RX",
    ...
    price: 249, firstMonth: 99, img: "💉", cls: "purple", url: "/intake-form/nad-wellness", published: true, sort: 11, clicks: 47,
  ...
  {
    id: "SHOP-012", name: "Sermorelin Injections", cat: "anti-aging", tag: "ANTI AGING · RX",
  ...
  {
    id: "SHOP-014", name: "Oral Minoxidil", cat: "hair", tag: "HAIR · RX",
    desc: "Low-dose daily tablet to support regrowth and density.",
    longDesc: "Low-dose oral minoxidil taken once daily to support thicker, fuller regrowth across the whole scalp.",
    price: 39, firstMonth: 19, img: "💊", cls: "amber", url: "/intake-form/hair-loss-treatment", published: true, sort: 14, clicks: 55,
    benefits: ["Supports regrowth across the whole scalp", "Simple once-daily tablet", "An option when topicals fall short", "Discreet monthly delivery"],
    safety: "Tell your provider about any heart condition, low blood pressure, or fluid retention. Not for use in pregnancy.",
  },
  {
    id: "SHOP-015", name: "Hair Spray", cat: "hair", tag: "HAIR · RX",
    desc: "All-in-one topical: finasteride, minoxidil & ketoconazole.",
    longDesc: "A compounded topical spray combining finasteride, minoxidil, and ketoconazole for an all-in-one daily hair routine.",
    price: 89, firstMonth: 49, img: "🧪", cls: "purple", url: "/intake-form/hair-loss-treatment", published: true, sort: 15, clicks: 28,
    benefits: ["Three actives in one daily spray", "Targets multiple causes of hair loss", "Easy topical application", "Discreet delivery"],
  ...
  },
  {
    ...
    price: 30, firstMonth: 30, img: "💊", cls: "blue", url: "/intake-form/ed-treatment", published: true, sort: 16, clicks: 88,
  ...
  },
  {
    ...
    price: 35, firstMonth: 35, img: "💊", cls: "amber", url: "/intake-form/ed-treatment", published: true, sort: 17, clicks: 79,
    benefits: ["Up to 36 hours of effect", "Daily or as-needed options", "Generic & affordable", "Discreet packaging"],
    safety: "Do not combine with nitrates. Tell your provider about heart conditions or blood-pressure medications. Seek care for an erection lasting more than 4 hours.",
  },
  {
    id: "SHOP-018", name: "Glutathione Injections", cat: "skin", tag: "SKIN · RX",
    desc: "Master-antioxidant injection for skin brightness & cellular health.",
    longDesc: "Glutathione injections deliver the body's master antioxidant to support skin brightness, detoxification, and cellular health.",
    price: 179, firstMonth: 99, img: "💉", cls: "silver", url: "/intake-form/glutathione-injection", published: true, sort: 18, clicks: 30,
    benefits: ["Supports skin brightness & clarity", "Antioxidant & detox support", "Twice-weekly injection", "Cold-chain shipping included"],
    safety: "Tell your provider about asthma, a sulfa/sulfite allergy, pregnancy, or nursing. May cause injection-site reactions.",
  },
  {
    id: "SHOP-019", name: "NAD+ Face Cream", cat: "skin", tag: "SKIN · RX",
    desc: "Topical NAD+ face cream for skin renewal and a youthful glow.",
    longDesc: "A topical NAD+ face cream that supports skin renewal and a healthy, youthful complexion as part of your daily routine.",
    price: 89, firstMonth: 59, img: "🧴", cls: "green", url: "/intake-form/nad-topical-nasal", published: true, sort: 19, clicks: 17,
    benefits: ["Supports skin renewal & glow", "Needle-free daily application", "Part of a healthy-aging routine", "Discreet shipping"],
    safety: "For external use only. Tell your provider about sensitive skin, active skin conditions, or any allergy, and patch-test before first use.",
  },
];

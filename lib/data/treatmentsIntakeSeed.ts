...
export const SEED_TREATMENTS: BaskTreatment[] = [
  ...
  { id:30, name:"Sildenafil (as needed)", med:"Sildenafil", strength:"50–100mg as needed", duration:"1", billing:"monthly", price:"$30", compare:"", desc:"Generic ED treatment taken as needed — the active ingredient in Viagra®.", icon:"💊", color:"blue", active:true, compounded:false, featured:false, subscribers:88, includes:["Sildenafil (monthly supply)","Async physician visit","Discreet packaging","Free shipping"], pharmacy:"Partner Network FL", freq:"As needed" },
  { id:31, name:"Tadalafil (daily or as needed)", med:"Tadalafil", strength:"5mg daily / 10–20mg as needed", duration:"1", billing:"monthly", price:"$35", compare:"", desc:"Generic ED treatment with up to 36 hours of effect — the active ingredient in Cialis®.", icon:"💊", color:"amber", active:true, compounded:false, featured:false, subscribers:79, includes:["Tadalafil (monthly supply)","Async physician visit","Discreet packaging","Free shipping"], pharmacy:"Partner Network FL", freq:"Daily or as needed" },
  { id:32, name:"Tretinoin", med:"Tretinoin", strength:"0.025–0.05%", duration:"1", billing:"monthly", price:"$45", compare:"", desc:"Prescription retinoid for anti-aging and acne.", icon:"🧴", color:"amber", active:true, compounded:false, featured:false, subscribers:34, includes:["Tretinoin topical (monthly supply)","Async physician visit","Skincare guidance","Free shipping"], pharmacy:"Partner Network FL", freq:"Nightly" },
  { id:33, name:"Custom Skin Formula", med:"Compounded topical (provider-selected)", strength:"varies", duration:"1", billing:"monthly", price:"$79", compare:"", desc:"Personalized topical blend formulated for your skin concerns.", icon:"🧴", color:"purple", active:true, compounded:true, featured:false, subscribers:12, includes:["Custom compounded topical (monthly supply)","Provider consultation","Skincare guidance","Free shipping"], pharmacy:"Partner Network FL", freq:"As directed" },
];

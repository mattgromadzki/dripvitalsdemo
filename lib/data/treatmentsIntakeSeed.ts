...
export const SEED_TREATMENTS: BaskTreatment[] = [
  { id:1, name:"1-Month Semaglutide Treatment", med:"Semaglutide", strength:"0.5mg/dose", duration:"1", billing:"monthly", price:"$189", compare:"$249", desc:"Month-to-month GLP-1 weight management program. Compounded semaglutide delivered to your door.", icon:"💉", color:"brand", active:true, compounded:true, featured:true, subscribers:0, includes:["Semaglutide 0.5mg/dose (4 units)","Async physician visit + monitoring","Free shipping via Partner Network"], pharmacy:"Partner Network FL", freq:"Once weekly" },
  ...
  { id:5, name:"6-Month Tirzepatide Treatment", med:"Tirzepatide", strength:"5–15mg", duration:"6", billing:"semi-annual", price:"$1,499", compare:"$2,100", desc:"Best-value 6-month program with full escalation to 15mg. Includes comprehensive lab panel and coaching.", icon:"🧬", color:"pink", active:true, compounded:true, featured:true, subscribers:0, includes:["Tirzepatide full escalation protocol","6 physician visits included","Full lab panel (A1C, lipids, CMP)","Dedicated care coordinator","Nutrition & lifestyle coaching"], pharmacy:"Partner Network FL", freq:"Once weekly" },
  { id:6, name:"1-Month NAD+ Injections", med:"NAD+", strength:"100mg/mL", duration:"1", billing:"monthly", price:"$249", compare:"", desc:"Monthly NAD+ injection program for cellular energy, cognitive function, and metabolic health.", icon:"⚡", color:"amber", active:true, compounded:true, featured:false, subscribers:0, includes:["NAD+ 100mg/mL (8 vials)","Injection training guide","Physician consultation","Cold-chain shipping included"], pharmacy:"Partner Network FL", freq:"Twice weekly" },
  ...
  { id:8, name:"12-Month Semaglutide Program", med:"Semaglutide", strength:"0.25–2.0mg", duration:"12", billing:"monthly", price:"$149", compare:"$189", desc:"Annual commitment program with the best per-month pricing. Full escalation protocol to maximum dose.", icon:"💪", color:"teal", active:true, compounded:true, featured:false, subscribers:0, includes:["Full-year semaglutide supply","Monthly physician visits","Quarterly labs included","Unlimited messaging","Body composition tracking"], pharmacy:"Partner Network FL", freq:"Once weekly" },
  ...
  { id:12, name:"1-Month Glutathione Injections", med:"Glutathione", strength:"200mg/mL", duration:"1", billing:"monthly", price:"$179", compare:"", desc:"Master-antioxidant glutathione injections to support skin brightness, detoxification, and cellular health.", icon:"✨", color:"teal", active:true, compounded:true, featured:false, subscribers:0, includes:["Glutathione 200mg/mL (8 vials)","Injection training guide","Physician consultation","Cold-chain shipping included"], pharmacy:"Partner Network FL", freq:"Twice weekly" },
...
export const SEED_FORMS: BaskIntakeForm[] = [
  {
    ...
    active: true, treatmentIds: [1,2,3,4,5,8,14,15,22,23], submissions: 0, qualified: 0,

...
export const SEED_TREATMENTS: BaskTreatment[] = [
  { id:1, name:"1-Month Semaglutide Treatment", med:"Semaglutide", strength:"0.5mg/dose", duration:"1", billing:"monthly", price:"$179", compare:"$249", desc:"Month-to-month GLP-1 weight management program. Compounded semaglutide delivered to your door.", icon:"💉", color:"brand", active:true, compounded:true, featured:true, subscribers:0, includes:["Semaglutide 0.5mg/dose (4 units)","Async physician visit + monitoring","Free shipping via Partner Network"], pharmacy:"Partner Network FL", freq:"Once weekly" },
  { id:2, name:"3-Month Semaglutide Treatment", med:"Semaglutide", strength:"0.5–1.0mg", duration:"3", billing:"quarterly", price:"$417", compare:"$747", desc:"Quarterly bundle with dose escalation from 0.5mg to 1.0mg. Best value for committed weight management.", icon:"💉", color:"brand", active:true, compounded:true, featured:false, subscribers:0, includes:["Semaglutide with dose escalation protocol","3 physician visits included","Priority shipping","Progress check-ins & coaching"], pharmacy:"Partner Network FL", freq:"Once weekly" },
  { id:3, name:"1-Month Tirzepatide Treatment", med:"Tirzepatide", strength:"5mg/dose", duration:"1", billing:"monthly", price:"$279", compare:"$389", desc:"Monthly dual GIP/GLP-1 treatment. Tirzepatide offers superior weight loss for eligible clients.", icon:"🧬", color:"purple", active:true, compounded:true, featured:false, subscribers:0, includes:["Tirzepatide 5mg (4 units)","Async physician consultation","Medication delivered to door"], pharmacy:"Partner Network FL", freq:"Once weekly" },
  { id:4, name:"3-Month Tirzepatide Treatment", med:"Tirzepatide", strength:"5–10mg", duration:"3", billing:"quarterly", price:"$597", compare:"$1,167", desc:"Quarterly tirzepatide program with structured escalation. Billed quarterly for maximum savings.", icon:"🧬", color:"purple", active:true, compounded:true, featured:true, subscribers:0, includes:["Tirzepatide with escalation 5mg → 10mg","3 quarterly physician visits","Lab monitoring (A1C, lipids)","Nutrition coaching module"], pharmacy:"Partner Network FL", freq:"Once weekly" },
  { id:5, name:"6-Month Tirzepatide Treatment", med:"Tirzepatide", strength:"5–15mg", duration:"6", billing:"semi-annual", price:"$954", compare:"$2,100", desc:"Best-value 6-month program with full escalation to 15mg. Includes comprehensive lab panel and coaching.", icon:"🧬", color:"pink", active:true, compounded:true, featured:true, subscribers:0, includes:["Tirzepatide full escalation protocol","6 physician visits included","Full lab panel (A1C, lipids, CMP)","Dedicated care coordinator","Nutrition & lifestyle coaching"], pharmacy:"Partner Network FL", freq:"Once weekly" },
  { id:6, name:"1-Month NAD+ Injections", med:"NAD+", strength:"100mg/mL", duration:"1", billing:"monthly", price:"$189", compare:"", desc:"Monthly NAD+ injection program for cellular energy, cognitive function, and metabolic health.", icon:"⚡", color:"amber", active:true, compounded:true, featured:false, subscribers:0, includes:["NAD+ 100mg/mL (8 vials)","Injection training guide","Physician consultation","Cold-chain shipping included"], pharmacy:"Partner Network FL", freq:"Twice weekly" },
  { id:7, name:"3-Month NAD+ Injections", med:"NAD+", strength:"100mg/mL", duration:"3", billing:"quarterly", price:"$447", compare:"$747", desc:"Quarterly NAD+ program with loading dose protocol. Ideal for sustained cellular health benefits.", icon:"⚡", color:"amber", active:true, compounded:true, featured:false, subscribers:0, includes:["NAD+ 100mg/mL (24 vials)","Loading dose protocol weeks 1–2","Quarterly physician check-in","Metabolic panel included","Priority cold-chain shipping"], pharmacy:"Partner Network FL", freq:"Twice weekly" },
  { id:8, name:"12-Month Semaglutide Program", med:"Semaglutide", strength:"0.25–2.0mg", duration:"12", billing:"annual", price:"$1,188", compare:"$189", desc:"Annual commitment program with the best per-month pricing. Full escalation protocol to maximum dose.", icon:"💪", color:"teal", active:true, compounded:true, featured:false, subscribers:0, includes:["Full-year semaglutide supply","Monthly physician visits","Quarterly labs included","Unlimited messaging","Body composition tracking"], pharmacy:"Partner Network FL", freq:"Once weekly" },
  { id:10, name:"1-Month Sermorelin Therapy", med:"Sermorelin", strength:"0.5mg/night", duration:"1", billing:"monthly", price:"$179", compare:"", desc:"Nightly sermorelin (GHRH) therapy to support sleep quality, recovery, energy, and healthy aging by stimulating your body's own growth hormone.", icon:"🌙", color:"purple", active:true, compounded:true, featured:false, subscribers:0, includes:["Sermorelin 0.5mg/night (30-day supply)","Injection training guide","Physician consultation","Cold-chain shipping included"], pharmacy:"Partner Network FL", freq:"Nightly, 5 nights/week" },
  { id:11, name:"3-Month Sermorelin Therapy", med:"Sermorelin", strength:"0.5mg/night", duration:"3", billing:"quarterly", price:"$417", compare:"$597", desc:"Quarterly sermorelin program — our most popular option for sustained sleep, recovery, and vitality benefits.", icon:"🌙", color:"purple", active:true, compounded:true, featured:true, subscribers:0, includes:["Sermorelin 0.5mg/night (90-day supply)","Quarterly physician check-in","Optional IGF-1 baseline lab","Priority cold-chain shipping"], pharmacy:"Partner Network FL", freq:"Nightly, 5 nights/week" },
  { id:12, name:"1-Month Glutathione Injections", med:"Glutathione", strength:"200mg/mL", duration:"1", billing:"monthly", price:"$139", compare:"", desc:"Master-antioxidant glutathione injections to support skin brightness, detoxification, and cellular health.", icon:"✨", color:"teal", active:true, compounded:true, featured:false, subscribers:0, includes:["Glutathione 200mg/mL (8 vials)","Injection training guide","Physician consultation","Cold-chain shipping included"], pharmacy:"Partner Network FL", freq:"Twice weekly" },
  { id:13, name:"3-Month Glutathione Injections", med:"Glutathione", strength:"200mg/mL", duration:"3", billing:"quarterly", price:"$357", compare:"$537", desc:"Quarterly glutathione program for sustained antioxidant and skin-health benefits.", icon:"✨", color:"teal", active:true, compounded:true, featured:false, subscribers:0, includes:["Glutathione 200mg/mL (24 vials)","Quarterly physician check-in","Priority cold-chain shipping","Skin-health progress check-ins"], pharmacy:"Partner Network FL", freq:"Twice weekly" },
  { id:14, name:"1-Month Oral Semaglutide", med:"Semaglutide (oral)", strength:"7–14mg daily", duration:"1", billing:"monthly", price:"$179", compare:"$299", desc:"Daily oral semaglutide for weight management — a needle-free GLP-1 option delivered to your door.", icon:"💊", color:"brand", active:true, compounded:true, featured:false, subscribers:0, includes:["Oral semaglutide (30-day supply)","Async physician visit + monitoring","Free shipping via Partner Network"], pharmacy:"Partner Network FL", freq:"Once daily" },
  { id:15, name:"1-Month Oral Tirzepatide", med:"Tirzepatide (oral)", strength:"varies", duration:"1", billing:"monthly", price:"$249", compare:"$429", desc:"Daily oral tirzepatide (dual GIP/GLP-1) for weight management — a needle-free option for eligible clients.", icon:"💊", color:"purple", active:true, compounded:true, featured:false, subscribers:0, includes:["Oral tirzepatide (30-day supply)","Async physician consultation","Medication delivered to door"], pharmacy:"Partner Network FL", freq:"Once daily" },
  { id:16, name:"1-Month Lipotropic (MIC + B12) Injections", med:"Lipotropic (MIC + B12)", strength:"—", duration:"1", billing:"monthly", price:"$129", compare:"", desc:"Weekly lipotropic injections combining methionine, inositol, choline, and B12 to support fat metabolism and energy.", icon:"🔥", color:"amber", active:true, compounded:true, featured:false, subscribers:0, includes:["Lipotropic MIC + B12 (4 doses)","Injection training guide","Physician consultation","Cold-chain shipping included"], pharmacy:"Partner Network FL", freq:"Once weekly" },
  { id:17, name:"1-Month NAD+ Nasal Spray", med:"NAD+ (intranasal)", strength:"—", duration:"1", billing:"monthly", price:"$149", compare:"", desc:"Needle-free intranasal NAD+ for daily cellular energy and cognitive support.", icon:"💨", color:"amber", active:true, compounded:true, featured:false, subscribers:0, includes:["NAD+ nasal spray (30-day supply)","Physician consultation","Discreet shipping"], pharmacy:"Partner Network FL", freq:"Daily" },
  { id:18, name:"1-Month NAD+ Face Cream", med:"NAD+ (topical)", strength:"—", duration:"1", billing:"monthly", price:"$89", compare:"", desc:"Topical NAD+ face cream to support skin renewal and a healthy, youthful complexion.", icon:"🧴", color:"pink", active:true, compounded:true, featured:false, subscribers:0, includes:["NAD+ face cream (30-day supply)","Application guide","Discreet shipping"], pharmacy:"Partner Network FL", freq:"Daily" },
  { id:19, name:"1-Month Oral Minoxidil", med:"Minoxidil (oral)", strength:"1.25–2.5mg daily", duration:"1", billing:"monthly", price:"$59", compare:"", desc:"Low-dose oral minoxidil to support hair regrowth and density.", icon:"💊", color:"teal", active:true, compounded:false, featured:false, subscribers:0, includes:["Oral minoxidil (30-day supply)","Async physician visit","Free shipping"], pharmacy:"Partner Network FL", freq:"Once daily" },
  { id:20, name:"1-Month Finasteride", med:"Finasteride", strength:"1mg daily", duration:"1", billing:"monthly", price:"$45", compare:"", desc:"Daily finasteride to slow hair loss and support regrowth in eligible patients.", icon:"💊", color:"blue", active:true, compounded:false, featured:false, subscribers:0, includes:["Finasteride 1mg (30-day supply)","Async physician visit","Free shipping"], pharmacy:"Partner Network FL", freq:"Once daily" },
  { id:21, name:"1-Month Hair Regrowth Spray", med:"Finasteride / Minoxidil / Ketoconazole (topical)", strength:"topical", duration:"1", billing:"monthly", price:"$89", compare:"", desc:"Compounded topical spray combining finasteride, minoxidil, and ketoconazole for an all-in-one daily hair routine.", icon:"💆", color:"purple", active:true, compounded:true, featured:true, subscribers:0, includes:["Compounded Fin/Min/Keto topical spray (30-day supply)","Application guide","Physician consultation","Free shipping"], pharmacy:"Partner Network FL", freq:"Daily (topical)" },
  { id:22, name:"3-Month Oral Semaglutide", med:"Semaglutide (oral)", strength:"7–14mg daily", duration:"3", billing:"quarterly", price:"$477", compare:"$687", desc:"Quarterly oral semaglutide bundle — needle-free GLP-1 weight management at the best per-month price.", icon:"💊", color:"brand", active:true, compounded:true, featured:false, subscribers:0, includes:["Oral semaglutide (90-day supply)","3 physician visits included","Priority shipping","Progress check-ins"], pharmacy:"Partner Network FL", freq:"Once daily" },
  { id:23, name:"3-Month Oral Tirzepatide", med:"Tirzepatide (oral)", strength:"varies", duration:"3", billing:"quarterly", price:"$717", compare:"$987", desc:"Quarterly oral tirzepatide bundle (dual GIP/GLP-1) — best value for committed, needle-free weight management.", icon:"💊", color:"purple", active:true, compounded:true, featured:false, subscribers:0, includes:["Oral tirzepatide (90-day supply)","3 physician visits included","Priority shipping","Progress check-ins"], pharmacy:"Partner Network FL", freq:"Once daily" },
  { id:24, name:"3-Month Lipotropic (MIC + B12) Injections", med:"Lipotropic (MIC + B12)", strength:"—", duration:"3", billing:"quarterly", price:"$329", compare:"$387", desc:"Quarterly lipotropic bundle to support fat metabolism and energy, billed quarterly for savings.", icon:"🔥", color:"amber", active:true, compounded:true, featured:false, subscribers:0, includes:["Lipotropic MIC + B12 (12 doses)","Quarterly physician check-in","Cold-chain shipping included"], pharmacy:"Partner Network FL", freq:"Once weekly" },
  { id:25, name:"3-Month NAD+ Nasal Spray", med:"NAD+ (intranasal)", strength:"—", duration:"3", billing:"quarterly", price:"$399", compare:"$447", desc:"Quarterly intranasal NAD+ bundle for sustained energy and cognitive support.", icon:"💨", color:"amber", active:true, compounded:true, featured:false, subscribers:0, includes:["NAD+ nasal spray (90-day supply)","Quarterly physician check-in","Discreet shipping"], pharmacy:"Partner Network FL", freq:"Daily" },
  { id:26, name:"3-Month NAD+ Face Cream", med:"NAD+ (topical)", strength:"—", duration:"3", billing:"quarterly", price:"$229", compare:"$267", desc:"Quarterly NAD+ face cream bundle for ongoing skin renewal and a youthful complexion.", icon:"🧴", color:"pink", active:true, compounded:true, featured:false, subscribers:0, includes:["NAD+ face cream (90-day supply)","Application guide","Discreet shipping"], pharmacy:"Partner Network FL", freq:"Daily" },
  ...
  { id:28, name:"3-Month Finasteride", med:"Finasteride", strength:"1mg daily", duration:"3", billing:"quarterly", price:"$119", compare:"$135", desc:"Quarterly finasteride bundle to slow hair loss and support regrowth in eligible patients.", icon:"💊", color:"blue", active:true, compounded:false, featured:false, subscribers:0, includes:["Finasteride 1mg (90-day supply)","Quarterly physician visit","Free shipping"], pharmacy:"Partner Network FL", freq:"Once daily" },
  { id:29, name:"3-Month Hair Regrowth Spray", med:"Finasteride / Minoxidil / Ketoconazole (topical)", strength:"topical", duration:"3", billing:"quarterly", price:"$229", compare:"$267", desc:"Quarterly bundle of the compounded Fin/Min/Keto topical spray — best value for the all-in-one hair routine.", icon:"💆", color:"purple", active:true, compounded:true, featured:false, subscribers:0, includes:["Compounded Fin/Min/Keto topical spray (90-day supply)","Application guide","Quarterly physician check-in","Free shipping"], pharmacy:"Partner Network FL", freq:"Daily (topical)" },
  // ── Brand-name GLP-1s (monthly). NOT compounded — dispensed as the branded
  // product via a retail/partner pharmacy. They also serve as price anchors on
  // the brand-bridge forms next to the compounded plans. Prices are typical
  // self-pay figures — edit in the Treatments tab to match your actual offer.
  { id:41, name:"Ozempic\u00AE (brand) \u2014 Monthly", med:"Semaglutide (Ozempic\u00AE brand)", strength:"0.25\u20132mg weekly", duration:"1", billing:"monthly", price:"$999", compare:"", desc:"Brand-name Ozempic\u00AE dispensed by a licensed pharmacy after provider approval.", icon:"\uD83D\uDC89", color:"blue", active:true, compounded:false, featured:false, subscribers:0, includes:["Brand-name Ozempic\u00AE (1-month supply)","Async physician visit","Pharmacy-dispensed \u00B7 cold-chain shipping"], pharmacy:"Partner Network FL", freq:"Once weekly" },
  { id:42, name:"Wegovy\u00AE (brand) \u2014 Monthly", med:"Semaglutide (Wegovy\u00AE brand)", strength:"0.25\u20132.4mg weekly", duration:"1", billing:"monthly", price:"$1,349", compare:"", desc:"Brand-name Wegovy\u00AE dispensed by a licensed pharmacy after provider approval.", icon:"\uD83D\uDC89", color:"blue", active:true, compounded:false, featured:false, subscribers:0, includes:["Brand-name Wegovy\u00AE (1-month supply)","Async physician visit","Pharmacy-dispensed \u00B7 cold-chain shipping"], pharmacy:"Partner Network FL", freq:"Once weekly" },
  { id:43, name:"Mounjaro\u00AE (brand) \u2014 Monthly", med:"Tirzepatide (Mounjaro\u00AE brand)", strength:"2.5\u201315mg weekly", duration:"1", billing:"monthly", price:"$1,069", compare:"", desc:"Brand-name Mounjaro\u00AE dispensed by a licensed pharmacy after provider approval.", icon:"\uD83E\uDDEC", color:"purple", active:true, compounded:false, featured:false, subscribers:0, includes:["Brand-name Mounjaro\u00AE (1-month supply)","Async physician visit","Pharmacy-dispensed \u00B7 cold-chain shipping"], pharmacy:"Partner Network FL", freq:"Once weekly" },
  { id:44, name:"Zepbound\u00AE (brand) \u2014 Monthly", med:"Tirzepatide (Zepbound\u00AE brand)", strength:"2.5\u201315mg weekly", duration:"1", billing:"monthly", price:"$1,086", compare:"", desc:"Brand-name Zepbound\u00AE dispensed by a licensed pharmacy after provider approval.", icon:"\uD83E\uDDEC", color:"purple", active:true, compounded:false, featured:false, subscribers:0, includes:["Brand-name Zepbound\u00AE (1-month supply)","Async physician visit","Pharmacy-dispensed \u00B7 cold-chain shipping"], pharmacy:"Partner Network FL", freq:"Once weekly" },
  { id:30, name:"Sildenafil (as needed)", med:"Sildenafil", strength:"50–100mg as needed", duration:"1", billing:"monthly", price:"$30", compare:"", desc:"Generic ED treatment taken as needed — the active ingredient in Viagra®.", icon:"💊", color:"blue", active:true, compounded:false, featured:false, subscribers:0, includes:["Sildenafil (monthly supply)","Async physician visit","Discreet packaging","Free shipping"], pharmacy:"Partner Network FL", freq:"As needed" },
  { id:31, name:"Tadalafil (daily or as needed)", med:"Tadalafil", strength:"5mg daily / 10–20mg as needed", duration:"1", billing:"monthly", price:"$35", compare:"", desc:"Generic ED treatment with up to 36 hours of effect — the active ingredient in Cialis®.", icon:"💊", color:"amber", active:true, compounded:false, featured:false, subscribers:0, includes:["Tadalafil (monthly supply)","Async physician visit","Discreet packaging","Free shipping"], pharmacy:"Partner Network FL", freq:"Daily or as needed" },
];
...
export const SEED_FORMS: BaskIntakeForm[] = [
  {
    ...
    active: true, treatmentIds: [1,2,3,4,5,8,14,15,22,23, 45, 46], submissions: 0, qualified: 0,
  ...
  },
  {
    ...
    active: true, treatmentIds: [6,7], submissions: 0, qualified: 0,
    hardRules: [
  ...
  {
    id: 9, name: "Sexual Health (ED) Intake", slug: "ed-treatment",
    desc: "Screening for clients interested in ED treatments (sildenafil and tadalafil).",
    active: true, treatmentIds: [30,31], submissions: 0, qualified: 0,
    hardRules: [
      { id:"ed-h1", icon:"💊", title:"Nitrate Use", desc:"Nitrates (e.g., nitroglycerin, isosorbide) or recreational 'poppers' with a PDE5 inhibitor can cause a dangerous drop in blood pressure.", active:true },
      { id:"ed-h2", icon:"🫀", title:"Recent Cardiac Event", desc:"Heart attack, stroke, or unstable chest pain in the last 6 months is a contraindication pending clearance.", active:true },
      { id:"ed-h3", icon:"👶", title:"Under 18 Years of Age", desc:"Offered to adults only.", active:true },
      { id:"ed-h4", icon:"⚠️", title:"Allergy to PDE5 Inhibitors", desc:"Hypersensitivity to sildenafil, tadalafil, or similar is a contraindication.", active:true },
    ],
    reviewRules: [
      { id:"ed-r1", icon:"🩺", title:"Cardiovascular Disease / BP", desc:"Heart disease, chest pain on exertion, or uncontrolled blood pressure — provider review required.", active:true },
      { id:"ed-r2", icon:"💉", title:"Alpha-blockers / BP Medications", desc:"Can interact with PDE5 inhibitors — review and dose adjustment.", active:true },
      { id:"ed-r3", icon:"🔴", title:"Priapism Risk", desc:"Prior priapism, sickle cell, leukemia, or multiple myeloma — review.", active:true },
      { id:"ed-r4", icon:"🫘", title:"Severe Liver / Kidney Disease", desc:"May require dose adjustment.", active:true },
    ],
    ...
    questions: [
      ...
      { id:904, type:"section",  text:"Health Screening", helper:"", sectionIcon:"🏥", impact:"none", required:false },
      { id:905, type:"yesno",    text:"Do you take any nitrate medication (e.g., nitroglycerin, isosorbide) or use recreational \"poppers\"?", helper:"Combining these with ED medication can dangerously lower blood pressure", impact:"disqualifier", required:true },
      { id:906, type:"yesno",    text:"Do you take riociguat (Adempas) or another guanylate cyclase stimulator?", helper:"", impact:"disqualifier", required:true },
      { id:907, type:"yesno",    text:"In the last 6 months, have you had a heart attack, stroke, or unstable chest pain?", helper:"", impact:"disqualifier", required:true },
      { id:908, type:"yesno",    text:"Do you have heart disease, chest pain with exertion, or uncontrolled high or low blood pressure?", helper:"", impact:"review", required:true },
      { id:909, type:"yesno",    text:"Do you take alpha-blockers or other blood-pressure medications?", helper:"", impact:"review", required:true },
      { id:910, type:"yesno",    text:"Have you ever had a painful erection lasting more than 4 hours (priapism), or do you have sickle cell disease, leukemia, or multiple myeloma?", helper:"", impact:"review", required:true },
      { id:911, type:"yesno",    text:"Do you have severe liver or kidney disease, or have you had sudden vision or hearing loss?", helper:"", impact:"review", required:true },
      { id:912, type:"checkbox", text:"Do any of these apply to you?", helper:"Select all that apply.", impact:"review", required:true, options:[
        { label:"None of these apply", flag:"ok" },
        { label:"Diabetes", flag:"ok" },
        { label:"High cholesterol", flag:"ok" },
        { label:"Peyronie's disease (curved erections)", flag:"review" },
        { label:"Prior prostate or pelvic surgery", flag:"review" },
      ] },
      { id:913, type:"section",  text:"Allergies & Medications", helper:"", sectionIcon:"💊", impact:"none", required:false },
      { id:914, type:"yesno",    text:"Are you allergic to sildenafil, tadalafil, or similar ED medications?", helper:"", impact:"disqualifier", required:true },
      { id:915, type:"long_text",text:"Please list all medications and supplements you currently take.", helper:"Include doses if known. Write \"None\" if not applicable.", impact:"none", required:true },
      { id:916, type:"long_text",text:"Please list any allergies (medications, foods, or other).", helper:"Write \"None\" if not applicable.", impact:"none", required:true },
      ...
      { id:931, type:"checkbox", text:"Please confirm the following before submitting:", helper:"", impact:"qualify", required:true, options:[
        { label:"I certify that the information I provided is accurate and complete", flag:"ok" },
        { label:"I understand I must NOT combine this medication with nitrates or \"poppers\"", flag:"ok" },
        { label:"I will seek emergency care for an erection lasting more than 4 hours or sudden vision/hearing loss", flag:"ok" },
        { label:"I authorize a DripVitals provider to review my intake and determine eligibility", flag:"ok" },
      ] },
    ],
  },
...
/* ── 2026 pricing expansion ─────────────────────────────────────────────────
   New longer terms cloned from their family plans (description/includes/
   pharmacy inherited), plus Scream Cream as a new product. Placed before the
   brand-bridge block so bridge forms pick the new plans up automatically. */
function clonePlan(baseId: number, id: number, months: number, billing: BaskBillingCycle, price: string, compare: string, name: string) {
  const b = SEED_TREATMENTS.find((t) => t.id === baseId);
  if (!b) return;
  SEED_TREATMENTS.push({ ...b, id, name, duration: String(months), billing, price, compare, featured: false, subscribers: 0, includes: [...b.includes] });
}
clonePlan(5,  45, 12, "annual",      "$1,548", "$3,348", "12-Month Tirzepatide Program");
clonePlan(2,  46, 6,  "semi-annual", "$714",   "$1,074", "6-Month Semaglutide Treatment");
clonePlan(11, 47, 6,  "semi-annual", "$594",   "$1,074", "6-Month Sermorelin Therapy");
clonePlan(7,  48, 6,  "semi-annual", "$714",   "$1,134", "6-Month NAD+ Injections");
clonePlan(7,  49, 12, "annual",      "$1,068", "$2,268", "12-Month NAD+ Injections");
clonePlan(13, 50, 6,  "semi-annual", "$594",   "$834",   "6-Month Glutathione Injections");
clonePlan(13, 51, 12, "annual",      "$1,068", "$1,668", "12-Month Glutathione Injections");
clonePlan(22, 53, 6,  "semi-annual", "$894",   "$1,074", "6-Month Oral Semaglutide");
clonePlan(22, 54, 12, "annual",      "$1,548", "$2,148", "12-Month Oral Semaglutide");
clonePlan(23, 55, 6,  "semi-annual", "$1,374", "$1,494", "6-Month Oral Tirzepatide");
clonePlan(23, 56, 12, "annual",      "$2,388", "$2,988", "12-Month Oral Tirzepatide");
SEED_TREATMENTS.push({ id: 52, name: "3-Month Scream Cream", med: "Scream Cream (topical)", strength: "Compounded topical", duration: "3", billing: "quarterly", price: "$89.97", compare: "", desc: "Compounded topical formulated to enhance arousal and sensitivity, prescribed after provider review.", icon: "\uD83D\uDC97", color: "pink", active: true, compounded: true, featured: false, subscribers: 0, includes: ["3-month supply", "Async provider review", "Discreet home delivery"], pharmacy: "GreenstoneRX FL", freq: "As directed" });
...
const MED_FORMS = [
  ...
  { id: 37, slug: "oral-semaglutide", med: "Semaglutide (oral)", cap: "Oral Semaglutide",  offset: 37000 },
  { id: 38, slug: "oral-tirzepatide", med: "Tirzepatide (oral)", cap: "Oral Tirzepatide",  offset: 38000 },
] as const;

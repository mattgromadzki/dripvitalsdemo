...
export const SEED_TREATMENTS: BaskTreatment[] = [
  ...
  { id:32, name:"Tretinoin", med:"Tretinoin", strength:"0.025–0.05%", duration:"1", billing:"monthly", price:"$45", compare:"", desc:"Prescription retinoid for anti-aging and acne.", icon:"🧴", color:"amber", active:true, compounded:false, featured:false, subscribers:0, includes:["Tretinoin topical (monthly supply)","Async physician visit","Skincare guidance","Free shipping"], pharmacy:"Partner Network FL", freq:"Nightly" },
  { id:33, name:"Custom Skin Formula", med:"Compounded topical (provider-selected)", strength:"varies", duration:"1", billing:"monthly", price:"$79", compare:"", desc:"Personalized topical blend formulated for your skin concerns.", icon:"🧴", color:"purple", active:true, compounded:true, featured:false, subscribers:0, includes:["Custom compounded topical (monthly supply)","Provider consultation","Skincare guidance","Free shipping"], pharmacy:"Partner Network FL", freq:"As directed" },
];
...
export const SEED_FORMS: BaskIntakeForm[] = [
  ...
  {
    id: 10, name: "Skin Treatment Intake", slug: "skin-treatment",
    desc: "Screening for clients interested in prescription skin treatments (tretinoin and custom topical formulas).",
    active: true, treatmentIds: [32,33], submissions: 0, qualified: 0,
    hardRules: [
      { id:"skin-h1", icon:"🤰", title:"Pregnant, Planning, or Breastfeeding", desc:"Retinoids are not safe during pregnancy or nursing.", active:true },
      { id:"skin-h2", icon:"👶", title:"Under 18 Years of Age", desc:"Offered to adults only.", active:true },
      { id:"skin-h3", icon:"⚠️", title:"Allergy to Retinoids / Components", desc:"Hypersensitivity to tretinoin or other ingredients is a contraindication.", active:true },
    ],
    reviewRules: [
      { id:"skin-r1", icon:"🧴", title:"Sensitive Skin / Eczema / Rosacea", desc:"May need a gentler formulation or strength.", active:true },
      { id:"skin-r2", icon:"💊", title:"Recent Isotretinoin (Accutane) Use", desc:"Recent oral retinoid use — provider review.", active:true },
    ],
    settings: { applies:"Skin Treatments", autoMode:"ai_review", submissionLimitPerPatient:"Unlimited", autoCloseAfter:"Off", strictValidation:true },
    notifications: DEFAULT_NOTIFICATIONS,
    questions: [
      { id:1000, type:"section",  text:"Your Goals", helper:"", sectionIcon:"🎯", impact:"none", required:false },
      { id:1001, type:"multiple", text:"What are your main skin goals?", helper:"", impact:"none", required:true, options:["Anti-aging / fine lines","Acne & breakouts","Dark spots / uneven tone","Overall texture & glow"] },
      { id:1002, type:"yesno",    text:"Have you used a prescription retinoid (e.g., tretinoin / Retin-A) before?", helper:"", impact:"none", required:true },
      { id:1004, type:"section",  text:"Health Screening", helper:"", sectionIcon:"🏥", impact:"none", required:false },
      { id:1005, type:"yesno",    text:"Are you currently pregnant, planning to become pregnant, or breastfeeding?", helper:"Prescription retinoids are not safe during pregnancy or nursing", impact:"disqualifier", required:true },
      { id:1006, type:"yesno",    text:"Have you taken isotretinoin (Accutane) in the past 6 months?", helper:"", impact:"review", required:true },
      { id:1007, type:"yesno",    text:"Do you have eczema, rosacea, or very sensitive/reactive skin?", helper:"", impact:"review", required:true },
      { id:1008, type:"checkbox", text:"Do any of these apply to you?", helper:"Select all that apply.", impact:"review", required:true, options:[
        { label:"None of these apply", flag:"ok" },
        { label:"Melasma / pigmentation", flag:"ok" },
        { label:"Frequent sun exposure or outdoor work", flag:"review" },
        { label:"History of skin cancer", flag:"review" },
        { label:"Currently using other prescription topicals", flag:"review" },
      ] },
      { id:1010, type:"section",  text:"Allergies & Medications", helper:"", sectionIcon:"💊", impact:"none", required:false },
      { id:1011, type:"yesno",    text:"Are you allergic to tretinoin, other retinoids, or any topical skincare ingredient?", helper:"", impact:"disqualifier", required:true },
      { id:1012, type:"long_text",text:"Please list any medications and skincare products you currently use.", helper:"Write \"None\" if not applicable.", impact:"none", required:true },
      { id:1013, type:"long_text",text:"Please list any allergies (medications, skincare, or other).", helper:"Write \"None\" if not applicable.", impact:"none", required:true },
      { id:1020, type:"section",  text:"About You", helper:"", sectionIcon:"👤", impact:"none", required:false },
      { id:1021, type:"personal_info", text:"Personal Information", helper:"Your name and contact details", impact:"none", required:true },
      { id:1022, type:"date",     text:"What is your date of birth?", helper:"You must be 18 or older to enroll", impact:"disqualifier", required:true },
      { id:1023, type:"text",     text:"What is your ZIP code?", helper:"For shipping and provider matching", impact:"none", required:true },
      { id:1024, type:"address",  text:"If approved, where should we ship your treatment?", helper:"", impact:"none", required:true },
      { id:1030, type:"section",  text:"Consent", helper:"", sectionIcon:"✍", impact:"none", required:false },
      { id:1031, type:"checkbox", text:"Please confirm the following before submitting:", helper:"", impact:"qualify", required:true, options:[
        { label:"I certify that the information I provided is accurate and complete", flag:"ok" },
        { label:"I understand retinoids are not safe in pregnancy and increase sun sensitivity", flag:"ok" },
        { label:"I understand some dryness, peeling, or irritation is common when starting", flag:"ok" },
        { label:"I authorize a DripVitals provider to review my intake and determine eligibility", flag:"ok" },
      ] },
    ],
  },
